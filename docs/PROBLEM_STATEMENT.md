...
> Fill in each section before asking a coding agent to implement the real agent logic. Leave a section blank only if it truly doesn't apply — don't delete sections.
